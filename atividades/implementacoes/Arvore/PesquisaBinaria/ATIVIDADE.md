...
public class ArvorePesquisaBinaria {
    ...
    public void mostrar() {
        ...
        int linhas = altura + 1;
        int colunas = (int) Math.pow(2, altura + 2);

        String[][] tela = new String[linhas][colunas];
        ...
        preencher(tela, raiz, 0, colunas / 2, colunas / 4);
    ...
    private void preencher(String[][] tela, No no, int nivel, int coluna, int deslocamento) {
        if (no == null)
            return;

        tela[nivel][coluna] = String.valueOf(no.valor);
